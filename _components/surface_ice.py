...
class IceSheet(Stepper):
    ...
    def __init__(self, maximum_snow_ice_height=10, sea_water_transition=False, **kwargs):
        """
        Args:
        ...
        self._epsilon = 1e-5
        self._sea_water_transition = sea_water_transition
    ...
    def array_call(self, raw_state, timestep):
        ...
        #outputs['area_type'] = raw_state['area_type']
        ...
        for col in range(num_cols):
            ...
            #if total_height <= 0 and area_type == 'sea_ice':
                #outputs['area_type'][col] = 'sea'
