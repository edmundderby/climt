...
class SrikanthSeaIce(Stepper):
    ...
    input_properties = {
        ...
        'sea_ice_thickness_distribution': {
            'dims': ['sea_ice_thickness_levels', '*'],
            'units':  'm^-1'
        },
        'dimensional_sea_ice_thickness_coordinates': {
            'dims': ['sea_ice_thickness_levels', '*'],
            'units': 'm'
        },
        'sea_ice_growth_rate': {
    ...
    def __init__(self, maximum_snow_ice_height=10, ocean_heat_flux=2, thickness_scale=1.5, fractional_sea_ice_export_rate=0.1/(365*24*3600), k1=0.048, k2=0.025, tau=0.401, allow_open_water=True, **kwargs):
        """
        Args:
        ...
        self._thickness_scale = thickness_scale #units [m]
        ...
        self._epsilon = 1e-5
        self._allow_open_water = allow_open_water
    ...
    def array_call(self, raw_state, timestep):
        ...
        outputs['sea_ice_thickness_distribution'][:] = raw_state['sea_ice_thickness_distribution']
        outputs['dimensional_sea_ice_thickness_coordinates'][:] = raw_state['dimensional_sea_ice_thickness_coordinates']
        ...
        for col in range(num_cols):
            ...
            mean_surface_temperature -= self._CH*wind_speed*(raw_state['surface_temperature']-raw_state['air_temperature'][0]) * first_level_air_density * 9.81 / np.abs(raw_state['air_pressure_on_interface_levels'][0] - raw_state['air_pressure_on_interface_levels'][1])
